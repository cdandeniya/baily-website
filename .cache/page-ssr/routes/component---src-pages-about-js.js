...
const hero_StyledSection=(0,styled_components_esm["default"])(styles/* Section */.wn).withConfig({displayName:"hero__StyledSection",componentId:"sc-uj7ww7-0"})(["padding-top:10rem;padding-bottom:10rem;overflow-x:hidden;min-height:60rem;",";",";"],styles/* media */.$_.tablet`
  ...
  `);const hero_StyledImage=(0,styled_components_esm["default"])(gatsby_image_module["default"]).withConfig({displayName:"hero__StyledImage",componentId:"sc-uj7ww7-5"})(["width:100%;",";"],styles/* media */.$_.tablet`display: none;`);const Hero=({data})=>{return/*#__PURE__*/index_js_default().createElement(hero_StyledSection,null,/*#__PURE__*/index_js_default().createElement(styles/* Container */.mc,{max:true},/*#__PURE__*/index_js_default().createElement(Row,null,/*#__PURE__*/index_js_default().createElement(Col,{bigger:true},/*#__PURE__*/index_js_default().createElement(BigText,null,"We're the Toymakers of the Future: Crafting Tomorrow's Learning Today"),/*#__PURE__*/index_js_default().createElement(Description,null,"Baily is empowering young minds to explore, create, and thrive in a digital world.")),/*#__PURE__*/index_js_default().createElement(Col,null,/*#__PURE__*/index_js_default().createElement(hero_StyledImage,{fluid:data.blast.childImageSharp.fluid,alt:"About us"})))));};/* harmony default export */ const hero = (Hero);
